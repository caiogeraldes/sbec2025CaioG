...
Ele aconselha Xenofonte ir a Delfos e interrogar o deus sobre a viage.
(Xen.\ \emph{Anab.} 3.1.5)
...
\ex.\label{gloss:mod} ἀλλ᾽ ἐξαρκῇ σοι τὰ ἔργα αὐτῶν ὁρῶντι σέβεσθαι καὶ τιμᾶν τοὺς θεούς.\\
...
\begin{center}
  \input{../fala/tables/model_copula_dist_effects.tex}
\end{center}
...
\begin{center}
  \input{../fala/tables/model_domain_effects.tex}
  \bigskip
  \input{../fala/tables/model_domain_cummulative_effects.tex}
\end{center}

\paragraph{Papel temático do controlador} % (fold)
\begin{center}
  \input{../fala/tables/model_theta_effects.tex}
  \bigskip
  \input{../fala/tables/model_theta_cummulative_effects.tex}
\end{center}
...
\begin{center}
  \input{../fala/tables/model_dialect_effects.tex}
\end{center}
