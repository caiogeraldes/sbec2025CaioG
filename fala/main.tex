...
principal possui um objeto no dativo ou genitivo co\hyp{}referencial ao suheito
...
concordância,
haver opção de controlador para o alvo (ou o objeto oblíquo da principal
ou o sujeito implícito da infinitiva), $[Caso]$ ser uma propriedade
...
\begin{center}
  \input{./tables/model_copula_dist_effects.tex}
\end{center}
...
\begin{center}
  \input{./tables/model_domain_effects.tex}
  \bigskip
  \input{./tables/model_domain_cummulative_effects.tex}
\end{center}
...
de atração de casa em comparação ao experienciadores e a quadriplicam em relação
a recipientes.

\begin{center}
  \input{./tables/model_theta_effects.tex}
  \bigskip
  \input{./tables/model_theta_cummulative_effects.tex}
\end{center}
...
\begin{table}[!hb]
  \centering
  \input{./tables/model_dialect_effects.tex}
\end{table}
